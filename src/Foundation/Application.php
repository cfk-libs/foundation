...
namespace Sellony\Foundation;

use Closure;
use Illuminate\Container\Container;
use Sellony\Contracts\Foundation\Application as ApplicationContract;
...
class Application extends Container implements ApplicationContract
{
    ...
    {
        foreach ([
            'app'                  => [self::class, \Illuminate\Contracts\Container\Container::class, \Sellony\Contracts\Foundation\Application::class, \Psr\Container\ContainerInterface::class],
            ...
            'request'               => [\Psr\Http\Message\RequestInterface::class],
            'response'              => [\Psr\Http\Message\ResponseInterface::class],
